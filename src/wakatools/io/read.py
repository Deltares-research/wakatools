...
def read_seismics(
    ...
    **kwargs,
    ...
    """
    General reader for seismic data files. Provides support for multiple Kingdom export
    formats via dedicated readers.
...
def read_borehole_xml(
    ...
    **kwargs
    ...
    -------
    `geost.Collection`
        GeoST Collection containing the borehole data.
